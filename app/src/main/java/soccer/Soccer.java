...
import com.eomcs.pms.handler.DeliveryAddHandler;
import com.eomcs.pms.handler.DeliveryListHandler;
import com.eomcs.pms.handler.Command;
import com.eomcs.pms.handler.CatalogAddHandler;
import com.eomcs.pms.handler.CatalogListHandler;
import com.eomcs.pms.handler.GoodbyeHandler;
import com.eomcs.pms.handler.HelloHandler;
import com.eomcs.pms.handler.UserAddHandler;
...
public class Soccer {
  ...
  public void service() {
    ...
    commandMap.put("/member/add", new UserAddHandler());
    ...
    commandMap.put("/food/add", new CatalogAddHandler());
    commandMap.put("/food/list", new CatalogListHandler(foodList));

    commandMap.put("/amount/add", new DeliveryAddHandler());
    commandMap.put("/amount/list", new DeliveryListHandler(amountList));
